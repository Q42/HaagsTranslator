...
namespace HaagsTranslator.Tests
{
  ...
  public class TranslatorTests
  {
    ...
    [TestCase("Kijkduin Zuiderstrand genieten periode bedenken hieronder routes stap je", "Kèkdùin Zùidâhstgand geniete periaude bedenke hieâhondâh roetes stappie")]
