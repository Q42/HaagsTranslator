...
namespace HaagsTranslator
{
  ...
  public static class Translator
  {
    ...
    static readonly string[][] TranslationReplacements = {
      ...
      new [] {"dige", "dege"}, // 'vertegenwoordiger'
      ...
      new []{"([^etv])(e|E)rg", "$1$2rreg"}, // 'kermis', 'ergens', geen 'achtergelaten', 'neergelegd', 'overgebleven'
      ...
      new [] { "([^o])md([^e])", "$1mp$2" }, // 'beroemdste', geen 'omdat', 'beroemde
